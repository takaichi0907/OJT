...
def main():
    ...
    try:
        ...
        while True:
            ...
            print("Waiting CL-Order ...",flush=True)
            ...
            if (Menu.decode('utf-8')) == '1':
                ...
                if len(Keys)==0:
                    ...
                    for RKey in Keys:
                        qqq =  qqq + str(RKey.decode('utf-8')) + "/"    ###qqqに追加していく###
                    byqqq = bytes(qqq, 'utf-8')     ###追加し終わったものをバイト化###
                    conn.send(byqqq)                 ###送信###
